  ...
  return `
    <div class='messagecontainer'>
      <div class='headermessage'>
        Test yourself with these 12 HQ Trivia questions.
      </div>
    </div>
  `
}
...
function generateFinalStreakElements(currentStreak, correctanswerText, currentQuestionText){
  return `
    <div class=streakModalWrapper>
      <div class='finalstreakcontainer' role='dialog' aria-labelledby='dialog-title' aria-describedby='dialog-description'>
        ...
        <div class='streakmessagemaincontainer'>
          ...
          <div class='streakdetailcontainer'>
            <div class='streakstats'>
              <div class='finalstreaktext'>Streak</div>
              <div class='finalstreaknumber'>${currentStreak}</div>
            </div>
            <div class='streakinstructions'>
              <p class='streakinstructions1'>Your streak is over.</p>
              <p class='streakinstructions2'>However, you can still continue to play and finish this round without affecting your streak or you can end to start a new round.</p>
            </div>
