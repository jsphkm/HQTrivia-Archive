...
const qa1 = [
  ...
  {
    q: 'If your clothes catch fire, you are supposed to stop, drop, and what?',
    a: [
      {
        'Think': 0,
        'Roll': 1,
    ...
    people: [5561, 972964, 2723, random_number()],
    savage: false
  }
];
...
const qa2 = [
  ...
  {
    q: 'What term refers to diving headfirst into a pool with arms wide open at the start?',
    a: [
      {
        'Pig dive': 0,
        'Swan dive': 1,
    ...
    people: [16893, 923885, 15546, random_number()],
    savage: false
  }
];
...
const qa3 = [
  ...
  {
    q: 'What was the name of the wrestling giant who starred in \"The Princess Bride\"?',
    a: [
      {
        'Gerry': 0,
        'Mitch': 0,
    ...
    people: [45478, 52742, 815842, random_number()],
    savage: false
  }
]
...
const qa4 = [
  ...
  },
  {
    ...
    people: [38080, 217917, 273302, random_number()],
    savage: false
  },
  {
  ...
  {
    q: 'Which of these words has won Oxford Dictionaries Word of the Year?',
    a: [
      {
        'Hundo': 0,
        'Unfriend': 1,
    ...
    people: [158290, 514297, 126777, random_number()],
    savage: false
  }
]
...
const qa5 = [
  ...
  {
    q: 'Another way to express the number 1000 is to write \"ten to the\" what?',
    a: [
      {
        'Thousandth power': 0,
        'Tenth power': 0,
    ...
    people: [25534, 253797, 226555, random_number()],
    savage: false
  }
]
...
const qa6 = [
  ...
  {
    q: 'In which of these terms does the initial refer to the name of an emperor?',
    a: [
      {
        'W-2': 0,
        'C-Section': 1,
    ...
    people: [41468, 96049, 87050, random_number()],
    savage: false
  }
]
...
const qa7 = [
  ...
  {
    q: 'What European mountain range is named for its visibility to incoming American ships?',
    a: [
      {
        'Pecos Bill': 0,
        'Picos de Europa': 1,
    ...
    people: [11030, 64989, 17097, random_number()],
    savage: false
  }
]
...
const qa8 = [
  ...
  {
    q: 'Which of these words can describe both a hat and a type of sleeve?',
    a: [
      {
        'Cap': 1,
        'Tam': 0,
    ...
    people: [39955, 7577, 18043, random_number()],
    savage: false
  }
]
...
const qa9 = [
  ...
  {
    q: 'From where did the Titanic originally set sail?',
    a: [
      {
        'United States': 0,
        'England': 0,
    ...
    people: [3626, 19394, 17133, random_number()],
    savage: true
  }
]
...
const qa10 = [
  ...
  {
    q: 'Which of these video game companies first made playing cards?',
    a: [
      {
        'Nintendo': 1,
        'Atari': 0,
    ...
    people: [8525, 4819, 4984, random_number()],
    savage: false
  }
]
...
const qa11 = [
  ...
  {
    q: 'Which of these is actually in the country of Scotland?',
    a: [
      {
        'County of Scotland': 0,
        'Scotland Yard': 0,
        'Skye, Scotland': 1,
        'Great Scott': 0
      }
    ],
    people: [1225, 521, 6976, random_number()],
    savage: false
  }
]
...
const qa12 = [
  ...
  {
    q: 'Though they all ended quickly, which of these late-night hosts had the shortest run?',
    a: [
      {
        'Magic Johnson': 0,
        'Pat Sajak': 0,
    ...
    people: [1912, 1397, 3631, random_number()],
    savage: false
  }
]
